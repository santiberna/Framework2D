...
std::optional<math::PackResult> math::PackRectangles(const std::vector<glm::uvec2>& rectangles, const glm::uvec2& packing_area, uint32_t margin)
{
...
math::PackResult math::PackRectanglesUntilSuccess(const std::vector<glm::uvec2>& rectangles, const glm::uvec2& packing_area, uint32_t margin)
{
